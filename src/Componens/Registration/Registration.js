            ...
            <div className="">
                <div className="App">
                    <div className='addUser'  >
                        <h3 className="my-5">Sign Up for 21 days free trial</h3>
                        ...
                        <div className="gender-radio">
                            <label htmlFor="number" className="form-labe " style={{marginRight:"1rem"}}><strong>Gender : </strong></label>
                        ...
                        <div className="city">
                            ...
                            <div className="dropdown">
                                ...
                                <label htmlFor="number" className="form-label" style={{marginRight:"1rem"}}><strong>City : </strong></label>

                                <select
                                    onChange={(e) => { onHandleChange(e) }}
                                    value={users.city || ""} name="city" id="city">
                                    <option value="" name="city">select city</option>
                                    <option value="pune" name="city" selected={(users || {}).city === "pune" ? true : false} >pune</option>
                                    <option value="mumbai" name="city" selected={(users || {}).city === "mumbai" ? true : false}>mumbai</option>
                                    <option value="kolkata" name="city" selected={(users || {}).city === "kolkata" ? true : false}>kolkata</option>
                                    <option value="bangluru" name="city" selected={(users || {}).city === "bangluru" ? true : false}>bangluru</option>
                                </select>
                            </div>
